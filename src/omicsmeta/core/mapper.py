...
def default_terms() -> list[OntologyTerm]:
    ...
    return [
        ...
        OntologyTerm("DOID:3068", "glioblastoma", "doid", ("gbm",), (FieldType.DISEASE,)),
        ...
        OntologyTerm("UBERON:0002113", "kidney", "uberon", ("renal tissue", "kidney tissue"), (FieldType.TISSUE,)),
        OntologyTerm("UBERON:0000955", "brain", "uberon", ("brain tissue",), (FieldType.TISSUE,)),
        ...
        OntologyTerm("CVCL:0045", "HEK293", "cellosaurus", ("hek-293", "293t", "hek 293"), (FieldType.CELL_LINE,)),
        OntologyTerm("CVCL:0004", "K-562", "cellosaurus", ("k562", "k 562"), (FieldType.CELL_LINE,)),
        OntologyTerm("CVCL:0065", "Jurkat", "cellosaurus", ("jurkat cells",), (FieldType.CELL_LINE,)),
        OntologyTerm("CVCL:0022", "U-87 MG", "cellosaurus", ("u87", "u-87", "u87mg", "u-87 mg"), (FieldType.CELL_LINE,)),
